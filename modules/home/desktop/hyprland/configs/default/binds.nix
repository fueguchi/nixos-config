{
  wayland.windowManager.hyprland.settings = {
      ...
      "SUPER, PRINT, exec, hyprshot -o $HOME/Pictures/Screenshots -m region --freeze"
      "SUPER, T, exec, /home/erik/nixos-config/modules/home/desktop/hyprland/configs/scripts/wallpaper" # unfortunelly i can't write this script with writeShellScriptBin to be more reproducible
      "SUPER, Q, exec, kitty"
